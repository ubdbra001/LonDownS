function output = func_importPCI2(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   PCIADDS106 = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   PCIADDS106 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   PCIADDS106 = importfile('PCI ADDS_106.csv', 2, 9092);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/08/25 11:53:17
